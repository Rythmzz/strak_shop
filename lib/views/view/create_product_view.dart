...
class CreateNewProducts extends StatefulWidget {
  const CreateNewProducts({super.key});
                        ...
                        onPressed: () async {
                          ...
                          if (_listXFilePicked[i] != null) {
                            setState(() {
                              ...
                              _product.setIndexImageName(
                                  i, _listXFilePicked[i]!.name);
                            });
                          } else {
        ...
        child: Wrap(
          ...
          children: _product.getListColor == []
              ...
              : [
                          ...
                          builder: (context) => StatefulBuilder(
                                ...
                                return AlertDialog(
                                  actions: [
                                    TextButton(
                                        onPressed: () {
                                          setState(() {
                                            ...
                                            if (!_product.getListColor.contains(
                                                _currentSelectColor)) {
                                              _product.addColor(
                                                  _currentSelectColor
                                                      .toString());
                                    ...
                                    CircleAvatar(
                                      backgroundColor: _currentSelectColor,
                                    )
                                  ],
                  ...
                  for (var x in _product.getListColor) chipColor(x)
                ],
        ),
      ),
    );
        ...
        child: Wrap(
          ...
          children: _product.getListSize == []
              ...
              : [
                  ...
                  for (var x in _product.getListSize) chipSize(x)
                ],
        ),
      ),
    );
